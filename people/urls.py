...
urlpatterns = patterns('',
    ...
    url(r'^people/add_new_person$', 'core.views.add_new_person'),
    url(r'^people/save_person$', 'core.views.save_person'),
    url(r'^people/person_profile/(?P<user_id>\d+)$', 'core.views.person_profile'),
    url(r'^people/delete_person/(?P<user_id>\d+)$', 'core.views.delete_person'),
